...
(function() {
  ...
  function renderIgnoreList() {
    // Ignore list is now rendered as the first entry in renderCategories()
  }
  ...
  function renderCategories() {
    ...
    // --- Ignore List pseudo-category (rendered first, at top of list) ---
    (function() {
      ...
      wordArea.style.minHeight = "250px";
