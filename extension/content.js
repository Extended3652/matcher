...
(function() {
  ...
  // ---------------------------------------------------------------------------
  // Route guard: do not run on Angular modstatus view
  // ---------------------------------------------------------------------------
  if (
  ...
  if (isModStatusRoute()) {
    console.log("CMS Highlighter: disabled on modstatus route (initial)");
    return;
  }
  ...
  function startObserver() {
    ...
    observer = new MutationObserver((mutations) => {
      if (isModStatusRoute()) return;
      // Debounce: Angular fires many mutations in rapid succession
      ...
      }, 80); // 80ms debounce — fast enough to feel instant, slow enough to batch
    });
  ...
  // ---------------------------------------------------------------------------
  // Storage change listener — auto-refresh when dictionary updates
  // ---------------------------------------------------------------------------
